                ...
                <div className="row g-0">
                  <div className="col-lg-8">
                    <div className="p-5">
                      ...
                      {/* Repeat the item details for each item in the cart */}
                      {/* Sample item */}
                      <CartItem />
  ...
  return (
    <div className="row mb-4 d-flex justify-content-between align-items-center">
      ...
      <div className="col-md-3 col-lg-3 col-xl-2 d-flex">
        <button className="btn btn-link px-2" oő/*nClick={() => handleDecrease()}*/>
          <i className="fas fa-minus"></i>
        </button>

        <input id="form1" min="0" name="quantity" defaultValue="1" type="number" className="form-control form-control-sm" />

        <button className="btn btn-link px-2" /*onClick={() => handleIncrease()}*/>
